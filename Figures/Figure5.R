...
#res_mediation = readRDS("tcga_pdac_mediation/results/06_TCGA_serial_med_top50_V2_K8_corrected_without_LF.rds")
res_mediation1 = readRDS("tcga_pdac_mediation/results/06_TCGA_CAT1_serial_med_V2_K8_corrected_with_selected_LF.rds")
res_mediation2 = readRDS("tcga_pdac_mediation/results/06_TCGA_CAT2_serial_med_V2_K8_corrected_with_selected_LF.rds")
...
#DAGvalidated_CAT1 <- readRDS("tcga_pdac_mediation/results/05_DAGvalidated_CAT1.rds")
DAGvalidated_CAT1 <- readRDS("tcga_pdac_mediation/results/05_DAG_validated_CAT1_withLF.rds")
DAGvalidated_CAT1 <- gsub("_", " ", DAGvalidated_CAT1)

#DAGvalidated_CAT2 <- readRDS("tcga_pdac_mediation/results/05_DAGvalidated_CAT2.rds")
DAGvalidated_CAT2 <- readRDS("tcga_pdac_mediation/results/05_DAG_validated_CAT2_withLF.rds")
