...
```{r med_run}
#mediation tobacco_dnam_survival with imm cells LF estimation integration K = 8
...
saveRDS(hdmax2_param_tobacco_dnam, "~/projects/tims-pdac/real_data/results/02_tcga_med_tobacco_dnam_V2_K8_corrected.rds")
