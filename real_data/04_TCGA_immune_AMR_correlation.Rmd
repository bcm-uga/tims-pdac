...
deconv = readRDS("~/projects/tims-pdac/real_data/tcga_pdac_mediation/results/01_tcga_data_expo_deconv.rds")
mean_meth_AMR = readRDS("~/projects/tims-pdac/real_data/results/03_tcga_top50_tobacco_AMR_fdr0_05_V2_K8_corrected.rds")
...
df_to_save = data.frame(AMR = cor_df$DNAm,
                        ...
                        cell_type = pval_df$Immune,
                        corr = corr_df$corr)
saveRDS(df_to_save, "~/projects/tims-pdac/real_data/results/04_tcga_AMR_imm_corr_fdr0_05_V2_K8_corrected.rds")

res = list(immune_cons = immune_cons, mean_meth_AMR = mean_meth_AMR)
saveRDS(res, "~/projects/tims-pdac/real_data/results/04_tcga_imm_AMR_matrix_fdr0_05_V2_K8_corrected.rds")
```
