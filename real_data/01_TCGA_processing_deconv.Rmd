...
ref_rna_bulk = readRDS("../../datashare/cometh_lot1/transcriptome/T_raw.rds")
...
library(InstaPrism)
library(MuSiC)
ref_rna_scpeng = readRDS("results/00_sc_peng.rds")
ref_rna_scragh = readRDS("results/00_sc_raghavan.rds")
```
...
# chr13
# loc_chr13 = readRDS("~/projects/thema_surv/loc_chr13.rds")
# nloc13 = rownames(data_meth$platform[which(data_meth$platform$Chromosome=="chr13"),])
# M_sample_13 =  M[, which(colnames(M) %in% nloc13)]
